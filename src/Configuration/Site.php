            ...
            ->children()
                ...
                ->arrayNode('custom')
                    ...
                    ->children()
                        ...
                        ->enumNode('multisite')
                            ->values([true, false, 'subdomain', 'subdomains'])
                            ->defaultFalse()
                            ->validate()
                                ->ifTrue(function ($v) {return 'subdomains' === $v;})
                                ->then(function () {return 'subdomain';})
                            ->end()
                        ->end()
                        ...
                        ->arrayNode('plugins')
                            ->prototype('array')
                                ->beforeNormalization()
                                    ->ifString()
                                    ->then(function ($v) {return ['plugin' => $v];})
                                ->end()
                                ->children()
                        ...
                        ->arrayNode('themes')
                            ->prototype('array')
                                ->beforeNormalization()
                                    ->ifString()
                                    ->then(function ($v) {return ['theme' => $v];})
                                ->end()
                                ->children()
